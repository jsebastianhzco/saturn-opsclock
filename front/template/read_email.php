                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-stack f-s-16"></i> Apps
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Read Email</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="card d-none d-xl-block">
                            <div class="card-body">
                                <button class="btn btn-primary w-100 rounded" data-bs-target="#staticBackdrop"
                                            ...
                                            <div class="modal-body">
                                                <form class="app-form">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" placeholder="@gmail.com"
                                                               type="email">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Subject :</label>
                                                        <input class="form-control" placeholder="type subject..."
                                                               type="text">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div>
                                                        <label class="form-label">Attached
                                                            File</label>
                            ...
                            Starred </span>
                                        ...
                                        <li class="tab-link" data-tab="6"><i
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center flex-wrap mb-3">
                                    <div class="flex-grow-1">
                                        <a class="btn p-0 pe-2" data-bs-original-title="Back To Inbox"
                                           data-bs-placement="top"
                                           data-bs-toggle="tooltip"
                                           href="./email.php" role="button">
                                            <i class="ti ti-arrow-left fs-4 text-dark"></i>
                                        </a>
                                        <button class="btn border-0 p-1" data-bs-original-title="Archive "
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                            <i class="ti ti-archive fs-5 text-dark"></i>
                                        </button>
                                        <button class="btn border-0 p-1" data-bs-original-title="Starred"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                            <i class="ti ti-star fs-5 text-dark"></i>
                                        </button>
                                        <button class="btn border-0 p-1" data-bs-original-title="Spam"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                            <i class="ti ti-alert-octagon fs-5 text-dark"></i>
                                        </button>
                                        <button class="btn border-0 p-1" data-bs-original-title="Delete"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                            <i class="ti ti-trash fs-5 text-dark"></i>
                                        </button>
                                        <button class="btn border-0 p-1" data-bs-original-title="Folder"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                            <i class="ti ti-folder fs-5 text-dark"></i>
                                        </button>
                                        <button class="btn border-0 p-1" data-bs-original-title="Labels"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                    ...
                                    <div class="justify-content-end">
                                        ...
                                        <button class="btn border-0 p-1" data-bs-original-title="Next"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                                            <i class="ti ti-chevron-left fs-5 text-dark"></i>
                                        </button>
                                        <button class="btn border-0 p-1" data-bs-original-title="Previous"
                                                data-bs-placement="top"
                                                data-bs-toggle="tooltip"
                                                type="button">
                        ...
                        <span class="bg-secondary h-45 w-45 d-flex-center b-r-50 position-relative ">
                          ...
                          <span
                                  class="position-absolute top-0 d-flex-center bg-success border border-light rounded-circle text-center p-1 f-s-10 end-0"></span>
                                        ...
                                        <div class="flex-grow-1 ps-2">
                                            ...
                                            <div class="btn-group hover-dropdown">
                                                <button aria-expanded="false"
                                                        class="btn waves-effect waves-light text-dark p-0"
                                                        data-bs-toggle="dropdown"
                                                        data-trigger="hover" type="button">to<i
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a class="dropdown-item">Date : <span
                                                                    class="text-muted f-s-14">29 Sep 2024</span></a>
                                                    </li>
                                                    <li><a class="dropdown-item">Subject : <span
                                                                    class="text-muted f-s-14">meeting
                                    invitation</span></a></li>
                                        ...
                                        <div class="d-none d-sm-block">
                                            <div class="btn-group dropdown-icon-none ps-2">
                                                <a aria-expanded="false" class="icon-btn dropdown-toggle"
                                            ...
                                            <div class="filebox">
                                                <div class="d-flex gap-3 align-items-center position-relative">
                                                    <div class="position-absolute start-0">
                                                        <img alt="" class="w-35 h-35"
                                                             src="../assets/images/icons/file.png">
                                                    </div>
                                                    <div class="flex-grow-1 mg-s-40">
                                                        <h6 class="mb-0">Metting Paper's</h6>
                                                        <p class="text-secondary mb-0">1MB</p>
                                                    </div>
                                                    <p class="file-data text-secondary f-w-500 mb-0"><i
                                                                class="ti ti-download fs-4"></i></p>
                                                </div>
                                            </div>
                                            <div class="filebox">
                                                <div class="d-flex gap-3 align-items-center position-relative">
                                    ...
                                    <button class="btn btn-primary rounded mb-1" type="button">
...
<!-- js -->
<script src="../assets/js/read_email.js"></script>
