                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-stack f-s-16"></i> Apps
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Orders Details</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <div class="card order-details-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-credit-card f-s-18 me-2"></i>Payment</h6>
                                            <div class="text-end">
                                                <p>Online</p>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-truck-delivery f-s-18 me-2"></i>Shipping</h6>
                                            <div class="text-end">
                                                <p> Fast Shipping</p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card order-details-card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-file-invoice text-secondary f-s-18 me-2"></i>Customer
                                            </h6>
                                            <div class="text-end">
                                                <p>Chris Coyier</p>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-mail f-s-18 text-secondary me-2"></i>Email</h6>
                                            <div class="text-end">
                                                <p>dam@1234.com</p>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-device-mobile f-s-18 text-secondary me-2"></i>contact
                                            </h6>
                                            <div class="text-end">
                                                <p>+1 111 134 111</p>
                                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card order-details-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-truck-delivery f-s-18 text-secondary me-2"></i>Shipping
                                            </h6>
                                            <div class="text-end">
                                                <p>#AD-01009099</p>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            <h6 class="f-w-600 text-dark"><i
                                                        class="ti ti-award f-s-18 text-secondary me-2"></i>Reward Points
                                            </h6>
                                            <div class="text-end">
                                                <p>100</p>
                                            </div>
