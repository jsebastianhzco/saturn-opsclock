                                                    ...
                                                    <div class="card-body">
                                                        <div class="share-menu-item" draggable="false">
                                                            <div
                                                                ...
                                                                <img src="../assets/images/avtar/7.png"
                                                                     alt="" class="img-fluid">
                                                            </div>
                                                            <div class="share-menu-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="nestedDemo" class="list-group nested-sortable">
                                    <div class="list-group-item">Tital 1</div>
                                    <div class="list-group-item">Tital 2</div>
                                    <div class="list-group-item">Tital3
                                        <div class="list-group nested-sortable">
                                            <div class="list-group-item">Tital 4</div>
                                            <div class="list-group-item" data-id="5">Tital 5</div>
                                            <div class="list-group-item" data-id="6">Tital 6</div>
                                        </div>
                                    </div>
                                    <div class="list-group-item" data-id="7">Tital 7</div>
                                    <div class="list-group-item" data-id="8">Tital 8</div>
                                    <div class="list-group-item" data-id="9">Tital 9</div>
                                    <div class="list-group-item" data-id="10">Tital10
                                        <div class="list-group nested-sortable">
                                            <div class="list-group-item" data-id="11">Tital 11</div>
                                            <div class="list-group-item" data-id="12">Tital 12</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row draggable-card-responsive" id="draggableCard">
                        ...
                        <div class="card draggable-card ">
                            <div class="card-body">
                                <div class="draggable-card-img">
                                    <img src="../assets/images/draggable/01.jpg " alt="" class="img-fluid">
                    ...
                    <div class="col-6 col-sm-6 col-lg-3">
                        <div class="card draggable-card">
                            <div class="card-body">
                                <div class="draggable-card-img">
                                    <img src="../assets/images/draggable/02.jpg " alt="" class="img-fluid">
                                    <div class="draggable-card-icon">
                                                <span class="bg-white h-45 w-45 d-flex-center b-r-50">
                                                    <i class="ph-fill  ph-heart text-danger f-s-18"></i>
                                                </span>
                    ...
                    <div class="col-6 col-sm-6 col-lg-3">
                        <div class="card draggable-card">
                            <div class="card-body">
                                <div class="draggable-card-img">
                                    <img src="../assets/images/draggable/03.jpg " alt="" class="img-fluid">
                                    <div class="draggable-card-icon">
                                                <span class="bg-white h-45 w-45 d-flex-center b-r-50">
                                                    <i class="ph-fill  ph-heart text-danger f-s-18"></i>
                                                </span>
                    ...
                    <div class="col-6 col-sm-6 col-lg-3">
                        <div class="card draggable-card">
                            <div class="card-body">
                                <div class="draggable-card-img">
                                    <img src="../assets/images/draggable/04.jpg " alt="" class="img-fluid">
                                    <div class="draggable-card-icon">
                                                <span class="bg-white h-45 w-45 d-flex-center b-r-50">
                                                    <i class="ph-fill  ph-heart text-danger f-s-18"></i>
                                                </span>
