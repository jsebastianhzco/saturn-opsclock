                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-cardholder f-s-16"></i>  Forms elements
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Checkbox & Radio</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 d-flex flex-column gap-2">
                                        ...
                                        <div class="form-check d-flex align-items-center gap-1">
                                            <input class="form-check-input f-s-18 mb-1 m-1" disabled
                                                   id="radio_disabled"
                                        ...
                                        <div class="form-check d-flex align-items-center gap-1">
                                            <input checked class="form-check-input f-s-18 mb-1 m-1"
                                                   id="radio_default2"
                            ...
                            <div class="card-body">
                                <div class="row d-flex flex-wrap gap-2">
                                    <div class="form-check d-flex">
                                        <input class="form-check-input mg-2" id="flexCheck" type="checkbox">
                                        <label class="form-check-label ms-2" for="flexCheck">
                                            checkbox
                                        </label>
                                    </div>
                                    <div class="form-check d-flex">
                                        <input class="form-check-input mg-2" id="flexCheckIndeterminate"
                                               type="checkbox">
                                    ...
                                    <div class="form-check d-flex">
                                        <input class="form-check-input mg-2" disabled id="flexCheckDisabled"
                                               type="checkbox">
                        ...
                        <div class="card equal-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2">
                                    <input checked class="btn-check" id="option1" name="options" type="radio">
                                    <label class="btn btn-primary b-r-22" for="option1">Checked</label>

                                    <input class="btn-check" id="option2" name="options" type="radio">
                                    <label class="btn btn-secondary b-r-22" for="option2">Radio</label>

                                    <input class="btn-check" disabled id="option3" name="options" type="radio">
                                    <label class="btn btn-success b-r-22" for="option3">Disabled</label>

                                    <input class="btn-check" id="option4" name="options" type="radio">
                                    <label class="btn btn-danger b-r-22" for="option4">Radio</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2">
                                    <input class="btn-check" id="btn-check" type="checkbox">
                                    <label class="btn btn-primary b-r-22" for="btn-check">Single toggle</label>
                                    <input checked class="btn-check" id="btn-check-2" type="checkbox">
                                    <label class="btn btn-secondary b-r-22" for="btn-check-2">Checked</label>
                                    <input checked class="btn-check" id="btn-check--2" type="checkbox">
                                    <label class="btn btn-success b-r-22" for="btn-check-2">Checked</label>
                                    <input class="btn-check" disabled id="btn-check-3" type="checkbox">
                                    <label class="btn btn-danger b-r-22" for="btn-check-3">Disabled</label>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <label class="btn btn-outline-primary b-r-22" for="btn-check-outlined">Single
                                        toggle</label>
                                    <input checked class="btn-check" id="btn-check-2-outlined" type="checkbox">
                                    <label class="btn btn-outline-secondary b-r-22"
                                           for="btn-check-2-outlined">Checked</label>
                                    <input checked class="btn-check" id="success-outlined"
                                           name="options-outlined" type="radio">
                                    <label class="btn btn-outline-success b-r-22" for="success-outlined">Checked
                                        success
                                        radio</label>
                                    <input class="btn-check" id="danger-outlined" name="options-outlined"
                                           type="radio">
                                    <label class="btn btn-outline-danger b-r-22" for="danger-outlined">Danger
                                        radio</label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-xl-4">
                                        <label class="form-checkimage">
                                            <input class="checkimage-input" name="radioimage" type="radio"
                                                   value="1">
                                            <span class="check-box radiobox">
                            <img alt="" class="checkbox-image w-100" src="../assets/images/bootstrapslider/02.jpg">
                          </span>
                                        </label>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                                        <label class="form-checkimage">
                                            <input class="checkimage-input" name="radioimage" type="radio"
                                                   value="1">
                                            <span class="check-box radiobox">
                            <img alt="" class="checkbox-image w-100" src="../assets/images/bootstrapslider/04.jpg">
                          </span>
                                        </label>
                                    </div>
                                    <div class="col-sm-6 col-xl-4">
                        ...
                        <div class="card equal-card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-xl-4">
                                        <label class="form-checkimage">
                                            <input class="checkimage-input" type="checkbox" value="1">
                                            <span class="check-box">
                            <img alt="" class="checkbox-image w-100" src="../assets/images/blog-app/03.jpg">
                          </span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 col-xl-4">
                                        <label class="form-checkimage">
                                            <input checked class="checkimage-input" type="checkbox" value="2">
                                            <span class="check-box">
                            <img alt="" class="checkbox-image w-100" src="../assets/images/blog-app/02.jpg">
                          </span>
                                        </label>
                                    </div>
                                    <div class="col-md-6 col-xl-4">
                                        <label class="form-checkimage">
                                            <input checked class="checkimage-input" disabled type="checkbox"
                                                   value="3">
                                            <span class="check-box">
                            <img alt="" class="checkbox-image w-100" src="../assets/images/blog-app/01.jpg">
                          </span>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card equal-card">
                            ...
                            <div class="card-body">
                                <div class="form-selectgroup">
                                    <div class="select-item">
                                        <input class="form-check-input" id="inlineRadio1" name="inlineRadioOptions"
                          ...
                          <span class="d-flex align-items-center">
                            <img alt="" class="w-30 h-30" src="../assets/images/checkbox-radio/logo2.png">
                            <span class="ms-2">
                              ...
                              <span class="d-block text-secondary">Select Credit/Debit card payment method</span>
                                    ...
                                    <div class="select-item">
                                        <input class="form-check-input" id="inlineRadio3" name="inlineRadioOptions"
                          ...
                          <span class="d-flex align-items-center">
                            ...
                            <span class="ms-2">
                                ...
                                <span class="d-block text-secondary">Select Paypal payment method</span>
                                    ...
                                    <div class="select-item">
                                        <input class="form-check-input" id="inlineRadio4" name="inlineRadioOptions"
                                               type="radio" value="option4">
                                        <label class="form-check-label" for="inlineRadio4">
                          <span class="d-flex align-items-center">
                            <img alt="" class="w-30 h-30" src="../assets/images/checkbox-radio/logo4.png">
                            <span class="ms-2">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card equal-card">
                          ...
                          <span class="d-flex align-items-center">
                            <span class="bg-secondary h-30 w-30 d-flex-center b-r-50 position-relative">
                              <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/2.png">
                              <span class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                            </span>
                            <span class="ms-2">
                                ...
                                <span class="d-block text-secondary">Web Designer</span>
                                    ...
                                    <div class="select-item">
                                        <input class="form-check-input" id="inlineCheckbox3" type="checkbox"
                                               value="option3">
                                        <label class="form-check-label" for="inlineCheckbox3">
                          <span class="d-flex align-items-center">
                            <span class="bg-secondary h-30 w-30 d-flex-center b-r-50 position-relative">
                              <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/3.png">
                              <span class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                            </span>
                            <span class="ms-2">
                                <span class="fs-6">Moen Deo</span>
                                <span class="d-block text-secondary">Web Devloper</span>
                            </span>
                          </span>
                                        </label>
                                    </div>
                                    <div class="select-item">
                                        <input class="form-check-input" id="inlineCheckbox4" type="checkbox"
                                               value="option4">
                                        <label class="form-check-label" for="inlineCheckbox4">
                          <span class="d-flex align-items-center">
                            <span class="bg-secondary h-30 w-30 d-flex-center b-r-50 position-relative">
                              <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/16.png">
                              <span class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                            </span>
                            <span class="ms-2">
                                    ...
                                    <div class="col-12">
                                        <div class="card shadow-none">
                                            <div class="card-body custom-selection address-content">
                                                ...
                                                <div>
                                                    <!-- <img src="../assets/images/form/16.png" alt=""> -->
                                                    <i class="ti ti-brand-appstore icon-bg"></i>
                                                    <p class="text-muted">Mobile app development is the act or
                                                        process by which a
                                        ...
                                        <div class="card shadow-none">
                                            <div class="card-body custom-selection address-content">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted">Web development is the work involved in
                                                        developing a
