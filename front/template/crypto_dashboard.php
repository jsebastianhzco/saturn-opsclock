                            ...
                            <div class="card-body">
                                ...
                                <ul class="transaction-list mt-3">
                                    <li class="transaction-list-item">
                                        <div class="h-40 w-40 d-flex-center b-r-10 overflow-hidden text-bg-secondary transaction-list-avtar">
                                    ...
                                    <li class="transaction-list-item">
                                        <div class="h-40 w-40 d-flex-center b-r-10 overflow-hidden text-bg-light transaction-list-avtar">
                                    ...
                                    <li class="transaction-list-item">
                                        <div class="h-40 w-40 d-flex-center b-r-10 overflow-hidden text-bg-dark transaction-list-avtar">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-3 p-1">
                                        <div class="currency-coin-box bg-primary">
                                            <div class="h-45 w-45 d-flex-center b-r-15 overflow-hidden  p-1 mb-3">
                                                <img src="../assets/images/dashboard/analytics/binance.png" alt="" class="img-fluid">
                                            </div>
                                    ...
                                    <div class="col-6 col-md-3 p-1">
                                        <div class="currency-coin-box bg-danger">
                                            <div class="h-45 w-45 d-flex-center b-r-15 overflow-hidden p-1 mb-3">
                                                <img src="../assets/images/dashboard/analytics/ethereum.png" alt="" class="img-fluid">
                                            </div>
                                    ...
                                    <div class="col-6 col-md-3 p-1">
                                        <div class="currency-coin-box bg-secondary">
                                            <div class="h-45 w-45 d-flex-center b-r-15 overflow-hidden  p-1 mb-3">
                                                <img src="../assets/images/dashboard/analytics/dogecoin.png" alt="" class="img-fluid">
                                            </div>
                                    ...
                                    <div class="col-6 col-md-3 p-1">
                                        <div class="currency-coin-box bg-success">
                                            <div class="h-45 w-45 d-flex-center b-r-15 overflow-hidden   p-1 mb-3">
                                                <img src="../assets/images/dashboard/analytics/turkish-lira.png" alt="" class="img-fluid">
                                            </div>
                                    ...
                                    <div class="tab-content" id="walletContent">
                                        <div class="tab-pane fade" id="buy-tab-pane" role="tabpanel" aria-labelledby="buy-tab"
                                            ...
                                            <div class="text-end mt-4">
                                                <a href="pricing.php" target="_blank" role="button" class="btn btn-success b-r-10">Buy Coin</a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="sell-tab-pane" role="tabpanel" aria-labelledby="sell-tab"
                                            ...
                                            <div class="text-end mt-4">
                                                <a href="pricing.php" target="_blank" role="button" class="btn btn-danger b-r-10">Sell Coin</a>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade active show" id="exchange-tab-pane" role="tabpanel"
                                            ...
                                            <div class="text-end mt-4">
                                                <a href="pricing.php" target="_blank" role="button" class="btn btn-primary b-r-10">Connect Wallet</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <div class="position-relative">
                                                    <div class="h-35 w-35 d-flex-center b-r-15 overflow-hidden bg-light-warning position-absolute">
                                                        <img src="../assets/images/dashboard/analytics/bitcoin.png" alt="" class="img-fluid">
                                                    </div>
                                                    <div class="ms-5">
                                                        <h6 class="mb-0">Bitcoin</h6>
                                                    </div>
                        ...
                        <div class="card card-added">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="../assets/images/dashboard/analytics/bg.png" class="img-fluid" alt="">
                                    <div>
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="profile.php" target="_blank" role="button" class="btn btn-primary">Added Card</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Crypto js-->
<script src="../assets/js/crypto_dashboard.js"></script>
<script src="../assets/js/crypto_dashboard_chart.js"></script>
</html>
