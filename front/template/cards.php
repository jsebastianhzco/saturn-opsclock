                ...
                <div class="row m-1">
                    <div class="col-12 ">
                        ...
                        <ul class="app-line-breadcrumbs mb-3">
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Cards</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="card">
                            <div class="card-header code-header">
                                <h5>Card Header</h5>
                                <a aria-controls="cardheader1" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader1">
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer code-footer">
                                <h5>Card Footer</h5>
                                <a aria-controls="cardheader2" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader2">
      ...
      &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        ...
                        <div class="card border-0">
                            <div class="card-header code-header">
                                <h5>Card Header</h5>
                                <a aria-controls="cardheader3" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader3">
      ...
      &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect">
                            <div class="card-header code-header">
                                <h5>Hover effect</h5>
                                <a aria-controls="cardheader4" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader4">
     ...
     &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-outline-primary">
                            <div class="card-header code-header">
                                <h5>Outline card</h5>
                                <a aria-controls="cardheader9" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader9">
       ...
       &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-outline-secondary">
                            <div class="card-header code-header">
                                <h5>Outline card</h5>
                                <a aria-controls="cardheader10" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader10">
       ...
       &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-light-primary">
                            <div class="card-header code-header">
                                <h5>Light card</h5>
                                <a aria-controls="cardheader12" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader12">
                                    <i class="ti ti-code source" data-source="card10"></i>
                                </a>

                            </div>
                            <div class="card-body">
                                <h6 class="text-primary-dark">Card body</h6>
                                <p class="text-primary-dark">With supporting text below lead-in to additional
                                    content below as a natural.</p>
                            </div>
                        </div>
       ...
       &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-light-secondary">
                            <div class="card-header code-header">
                                <h5>Light card</h5>
                                <a aria-controls="cardheader11" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader11">
                                    <i class="ti ti-code source" data-source="card11"></i>
                                </a>

                            </div>
                            <div class="card-body">
                                <h6 class="text-secondary-dark">Card body</h6>
                                <p class="text-secondary-dark">With supporting text below lead-in to additional
                                    content below as a natural.</p>
                            </div>
                        </div>
        ...
        &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-light-primary">
                            <div class="card-body">
                                ...
                                <h6 class="text-primary-dark">Card With icon</h6>
                                <p class="text-primary-dark">With supporting text below lead-in to additional
                                    content below as a natural.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-primary">
                            <div class="card-header code-header">
                                <h5>Primary card</h5>
                                <a aria-controls="cardheader5" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader5">
     ...
     &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-secondary">
                            <div class="card-header code-header">
                                <h5>Secondary card</h5>
                                <a aria-controls="cardheader6" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader6">
     ...
     &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-success">
                            <div class="card-header code-header">
                                <h5>Success card</h5>
                                <a aria-controls="cardheader7" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader7">
     ...
     &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="card hover-effect card-danger">
                            <div class="card-header code-header">
                                <h5>Danger card</h5>
                                <a aria-controls="cardheader8" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#cardheader8">
     ...
     &lt;/div&gt;
                    ...
                    <div class="col-md-6 col-xxl-4">
                        <div class="card overflow-hidden hover-effect">
                            <img alt="..." class="card-img-top" src="../assets/images/blog-app/06.jpg">
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-xxl-4">
                        <div class="card overflow-hidden  hover-effect">
                            ...
                            <img alt="..." class="card-img-bottom" src="../assets/images/blog-app/02.jpg">
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-md-6">
                                <div class="card hover-effect">
                                    ...
                                    <div class="card-body">
                                        <p>I am a keen, hard working, reliable and excellent time keeper. I am a
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <ul class="avatar-group float-end">
                                                    ...
                                                    <li class="text-bg-primary h-25 w-25 d-flex-center b-r-50"
                        ...
                        <div class="card mb-3 hover-effect">
                            <div class="row g-0">
                                <div class="col-md-6 col-xl-4">
                                    <img alt="..." class="img-fluid" src="../assets/images/blog-app/08.jpg">
                                </div>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button aria-controls="howowrk-tab-pane" aria-selected="false"
                                                ...
                                                tabindex="-1" type="button"><i
                                                    class="ti ti-keyboard-show pe-1"></i> How It
                                            Works
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button aria-controls="drawbacks-tab-pane" aria-selected="false"
                                                ...
                                                role="tab" tabindex="-1"
                                                type="button"><i
                                                    class="ti ti-file-dislike pe-1"></i>Drawbacks
                                        </button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="LightContent">
                                    <div aria-labelledby="description-tab" class="tab-pane fade active show"
                        ...
                        <div class="card mb-3  hover-effect">
                            <div class="row g-0">
                                <div class="col-md-6 col-xl-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Card title</h5>
                                        <p class="card-text">This is a wider card with supporting text with
                                            supporting little bit longer
                                            below as a natural below as a natural lead-in to additional content.
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <img alt="..." class="img-fluid" src="../assets/images/blog-app/09.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card hover-effect equal-card tab-card">
                            <div class="card-body">
                                <ul class="nav nav-tabs tab-primary bg-primary p-1" id="bg" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button aria-controls="features-tab-pane" aria-selected="false"
                                                class="nav-link"
                                                data-bs-target="#features-tab-pane" data-bs-toggle="tab"
                                                id="features-tab"
                                                role="tab"
                                                tabindex="-1" type="button"><i class="ti ti-disc pe-1"></i>
                                            features
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button aria-controls="history-tab-pane" aria-selected="false"
                                                ...
                                                role="tab"
                                                tabindex="-1" type="button"><i
                                                    class="ti ti-history pe-1"></i>History
                                        </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button aria-controls="reviews-tab-pane" aria-selected="true"
                                                class="nav-link active"
                                                data-bs-target="#reviews-tab-pane" data-bs-toggle="tab"
                                                id="reviews-tab"
                                                role="tab"
                                                type="button"><i class="ti ti-star pe-1"></i>reviews
                                        </button>
                                    </li>

                                </ul>
                                <div class="tab-content" id="bgContent">
                                    <div aria-labelledby="features-tab" class="tab-pane fade" id="features-tab-pane"
                                         role="tabpanel"
                                         tabindex="0">
                                        <p>The idea is to use <code>:target</code> pseudoclass to show tabs, use
                                            anchors with fragment
                                    ...
                                    <div aria-labelledby="reviews-tab" class="tab-pane fade active show"
                                         id="reviews-tab-pane"
                                         role="tabpanel" tabindex="0">
                                        <p>The idea is to use <code>:target</code> pseudoclass to show tabs, use
                                            anchors with fragment
