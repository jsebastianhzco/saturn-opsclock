                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-briefcase f-s-16"></i> Ui kits
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Alert</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                <h5>Basic Alert</h5>
                                <a aria-controls="simpalalertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#simpalalertExample">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                ...
                                <a aria-controls="lightalertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#lightalertExample">
                            ...
                            <div class="card-body">
                                <div class="alert alert-light-primary" role="alert">
                                    Light primary color alert with <a class="alert-link" href="#">an example
                                        link</a> -Check it!
                                </div>
                                <div class="alert alert-light-secondary" role="alert">
                                    Light secondary color alert with <a class="alert-link" href="#">an example
                                        link</a> -Check it!
                                </div>
                                <div class="alert alert-light-success" role="alert">
                                    Light success color alert with <a class="alert-link" href="#">an example
                                        link</a> -Check it!
                                </div>
                                <div class="alert alert-light-danger" role="alert">
                                    Light danger color alert with <a class="alert-link" href="#">an example link</a>
                                    -Check it!
                                </div>
                                <div class="alert alert-light-warning" role="alert">
                                    Light warning color alert with <a class="alert-link" href="#">an example
                                        link</a> -Check it!
                                </div>
                                <div class="alert alert-light-info" role="alert">
                                    Light info color alert with <a class="alert-link" href="#">an example link</a>
                                    -Check it!
                                </div>
                                <div class="alert alert-light-light" role="alert">
                                    Light light color alert with <a class="alert-link" href="#">an example link</a>
                                    -Check it!
                                </div>
                                <div class="alert alert-light-dark" role="alert">
                                    Light dark color alert with <a class="alert-link" href="#">an example link</a>
                                    -Check it!
                                </div>
     ...
     &lt;div class=&quot;alert alert-light-dark &quot; role=&quot;alert&quot;&gt; Light dark color alert with an example link check it   &lt;/div&gt;
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                <h5>Outline Alert </h5>
                                <a aria-controls="outlinealertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#outlinealertExample">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                ...
                                <a aria-controls="lightborderalertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#lightborderalertExample">
                            ...
                            <div class="card-body">
                                <div class="alert alert-light-border-primary d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-download f-s-18 me-2"></i> Light-border-primary alert With
                                        icons -check it out!
                                    </p>
                                ...
                                <div class="alert alert-light-border-secondary d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-accessible-off-filled f-s-18 me-2"></i>Light-border-secondary
                                        alert With icons
                                        -check it out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                                ...
                                <div class="alert alert-light-border-success d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-circle-check f-s-18 me-2"></i>Light-border-success alert
                                        With icons -check it
                                        out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                                ...
                                <div class="alert alert-light-border-danger d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-power f-s-18 me-2"></i>Light-border-danger alert With icons
                                        -check it out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                                </div>
                                <div class="alert alert-light-border-warning d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-alert-triangle f-s-18 me-2"></i>Light-border-warning alert
                                        With icons -check it
                                        out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                                ...
                                <div class="alert alert-light-border-info d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-info-circle f-s-18 me-2"></i>Light-border-info alert With
                                        icons -check it out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                                </div>
                                <div class="alert alert-light-border-light d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-align-box-bottom-center f-s-18 me-2"></i>Light-border-light
                                        alert With icons
                                        -check it out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                                ...
                                <div class="alert alert-light-border-dark d-flex align-items-center justify-content-between"
                                     role="alert">
                                    <p class="mb-0">
                                        <i class="ti ti-world-download f-s-18 me-2"></i>Light-border-dark alert With
                                        icons -check it
                                        out!
                                    </p>
                                    <i class="ti ti-x" data-bs-dismiss="alert"></i>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                ...
                                <a aria-controls="leftborderalertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#leftborderalertExample">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                ...
                                <a aria-controls="labeliconExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#labeliconExample">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                ...
                                <a aria-controls="customeralertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#customeralertExample">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary alert-dismissible cookies-alert" role="alert">
                                    <div class="d-flex justify-content-between">
                                        <img alt="image" class="w-35 h-35 me-2"
                                ...
                                <div class="alert alert-label alert-label-success justify-content-between shopping-alert"
                                    ...
                                    <button class="btn btn-sm btn-success" data-bs-dismiss="alert" type="button">
                                        Accept
                                    </button>
                                </div>
                                ...
                                <div class="alert alert-border-info" role="alert">
                                    ...
                                    <p>
                                        With this new Version you have accesss to more customization features and
                                        file export options.
                                    </p>
                                    <div class="text-end">
                                ...
                                <div class="alert custom-alert p-0" role="alert">
                                    ...
                                    <div class="alert-body">
                                        ...
                                        <div class="text-end">
                                            <button class="btn btn-light-warning" type="button">Get more info
                                            </button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="d-flex justify-content-between code-header card-header">
                                ...
                                <a aria-controls="addithionalalertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#addithionalalertExample">
                            ...
                            <div class="card-body">
                                <div class="alert alert-primary" role="alert">
                                    <h4 class="alert-heading">Well done! <i
                                                class="ti ti-x float-end breadcrumb-start"
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header code-header">
                                <h5>Live Alert</h5>
                                <a aria-controls="livealertExample" aria-expanded="false"
                                   data-bs-toggle="collapse" href="#livealertExample">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-light-primary" id="liveAlertBtn" type="button">Show live
                                    alert
                                </button>
                            </div>
