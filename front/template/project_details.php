                                                ...
                                                <td class="text-end">
                                                    <ul class="avatar-group justify-content-end">
                                                        <li class="text-bg-danger h-30 w-30 d-flex-center b-r-50"
                                                            data-bs-toggle="tooltip" data-bs-title="Everlee Lambert">
                                                            A
                                                        </li>
                                                        <li class="text-bg-dark h-30 w-30 d-flex-center b-r-50"
                                                            data-bs-toggle="tooltip" data-bs-title="Hunter Scott">
                                                            CD
                                                        </li>
                                    ...
                                    <div class="project-team-list">
                                        <div class="d-flex align-items-center">
                                            <div class="bg-primary h-35 w-35 d-flex-center b-r-10 overflow-hidden">
                                                <img src="../assets/images/avtar/7.png" alt="" class="img-fluid">
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center  mt-3">
                                            <div class="bg-secondary h-35 w-35 d-flex-center b-r-10 overflow-hidden">
                                                <img src="../assets/images/avtar/13.png" alt="" class="img-fluid">
                                            </div>
                                            <div class="flex-grow-1 ps-2">
                                    ...
                                    <ul class="app-timeline-box">
                                            ...
                                            <div class="timeline-content pt-0 ">
                                                <div class="d-flex f-s-16">
                                                    ...
                                                    <span class="text-secondary ms-2">added reacton
                                                        in <span class="badge text-outline-primary me-2">#
                                            ...
                                            <div class="timeline-content pt-0 ">
                                                <div class="d-flex f-s-16">
                                                    <p class="text-success f-s-16 mb-0">Dane Wiza
                                                        ...
                                                        reacton in <span class="badge text-outline-success me-2">#
                                                            product website</span>post</span>
                                                ...
                                                <div class="timeline-border-box me-2 ms-0 mt-3">
                                                    ...
                                                    <p class="mb-4 text-secondary">Hello everyone,
                                                        ...
                                                        marketing emails</p>
                                                    <span class="badge text-outline-success me-2 timeline-badge">#🙂❤
                                                        10Reactions</span>
                                        ...
                                        <li class="timeline-section">
                                            ...
                                            <div class="timeline-content pt-0">
                                                ...
                                                <button type="button" class="btn btn-outline-danger">Rejects</button>
                                            </div>
                                        ...
                                        <li class="timeline-section">
                                            ...
                                            <div class="timeline-content pt-0">
                                                ...
                                                <button type="button" class="btn btn-outline-primary">Rejects</button>
                                            </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-sm btn-primary ms-2 me-2 b-r-4" type="button"><i
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="text-muted">
                                            The success of a project relies heavily on effective project management,
                                            which involves the careful planning, organizing, and controlling of
                                            resources to ensure that the project objectives are met. This includes
                                            defining the project scope, setting realistic timelines and budgets.
                                        </p>
                                    </div>
                                    <div class="mb-3">
                                        <h6>Background information</h6>
                                        <p class="text-muted"> A project is a planned endeavor that aims to achieve a
                                            specific goal within a defined timeframe. It involves a series of tasks and
                                            activities that are coordinated and executed by a team of individuals.
                                            Projects can vary in size, complexity, and scope, ranging from small-scale
                                            initiatives to large-scale undertakings that span across multiple
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="data-list-box mt-3">
                                        ...
                                        <div class="filebox">
                                            <div class="d-flex align-items-center position-relative">
                                                <div class="position-absolute start-0">
                                                    <img src="../assets/images/icons/folder.png" class="w-35 h-35"
                                                        alt="">
                                                </div>
                                                <div class="flex-grow-1 mg-s-40">
                                        ...
                                        <div>
                                            <a href="filemanager.php" role="button" class="btn btn-primary w-100">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
