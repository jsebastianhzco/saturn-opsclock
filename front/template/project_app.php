                                        ...
                                        <div class="card hover-effect" id="card1">
                                            <div class="card-header">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <a href="project_details.php" target="_blank" class="flex-grow-1 ps-2">
                                    ...
                                    <div class="col-md-6 col-xl-4 project-card">
                                        <div class="card hover-effect">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted f-s-14 text-secondary txt-ellipsis-2">I am a keen, hard working, reliable and
                                                    excellent time keeper. I am a bright and receptive person</p>
                                                <div class="text-end mb-2">
