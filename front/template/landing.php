...
<head>
    ...
    <title>Axelit - PHP Admin Template</title>
        ...
        <div class="navbar navbar-expand-lg sticky-top landing-nav_main px-3 position-fixed w-100">
            <div class="container-fluid">
                <a class="navbar-brand logo" href="index.php">
                    <img alt="#" src="../assets/images/logo/axelit-white.png">
                </a>
                    ...
                    <div class="col-lg-6 offset-lg-3 position-relative">
                        <div class="landing-heading text-center">
                            ...
                            <img alt="shape" class="img-fluid landing-vector-shape"
                                 src="../assets/images/landing/vector-shaps.png">
                            <p>axelit Comes with so many sidebar option , <br> layouts like RTl & many more ...!</p>
                            <div class="mg-t-60">
                                <a class="btn btn-primary py-3 px-4 b-r-50 btn-lg" href="index.php"
                                   role="button"
                                   target="_blank">Check Now</a>
                                <a class="btn btn-danger py-3 px-4 b-r-50 btn-lg ms-2" href="https://phpstack-1384472-5121645.cloudwaysapps.com/document/php/axelit/index.html"
                                   role="button"
                    ...
                    <div class="col-12">
                        <div class="landing-img">
                            <div class="img-box">
                                ...
                                <div>
                                    <img alt="img" class="box-img-1" src="../assets/images/landing/banner-img.gif">
                                </div>

                                <div>
                                    <img alt="img" class="box-img-4 " src="../assets/images/landing/banner-img-1.gif">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="language-box">
                <div class="language-box-item">
                    <a href="./index.php" target="_blank" class="primary-box bg-primary h-60 w-60 d-flex-center b-r-20"
                       data-bs-toggle="tooltip" data-bs-custom-class="custom-dark" data-bs-html="true"
                       data-bs-original-title="PHP">
                        <i class="devicon-php-plain f-s-28 align-text-bottom"></i>
                    </a>
                </div>
                <div class="language-box-item">
                    <a href="https://www.figma.com/design/Xmv0dYJsGQClbLD79TwrWk/axelit-figma-screenshot?node" target="_blank" class="danger-box bg-danger h-60 w-60 d-flex-center b-r-20" data-bs-toggle="tooltip"
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="index.php"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22"
                                                   href="ecommerce_dashboard.php" role="button"
                                                   target="_blank">
                                                    <i
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/calander.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Calender</h6>
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="calendar.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="profile.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="team.php"
                                                   role="button" target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="chat.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="email.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Ecommerce</h6>
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="product.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/todo.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Todo</h6>
                                                <a class="btn btn-light-success icon-btn b-r-22" href="to_do.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="filemanager.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="blog.php"
                                                   role="button" target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="alert.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="badges.php" role="button"
                                                   target="_blank">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/buttons.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Buttons</h6>
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="buttons.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="dropdown.php" role="button"
                                                   target="_blank">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/avtar.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Avtar</h6>
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="avtar.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning  icon-btn b-r-22" href="accordions.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="progress.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="notifications.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="modals.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="sweetalert.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="animation.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="video_emaded.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="tour.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="slick.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="ratings.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="count_down.php" role="button"
                                                   target="_blank">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/font-awesome.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Fontawesome Icons</h6>
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="fontawesome.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="flag_icons.php" role="button"
                                                   target="_blank">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/animated.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Animated Icons</h6>
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="animated_icon.php" role="button"
                                                   target="_blank">
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/weather.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Whether Icons</h6>
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="weather_icon.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="basic_table.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="data_table.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="list_table.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="advance_table.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="base_inputs.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="form_validation.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="checkbox_radio.php" role="button"
                                                   target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="input_masks.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                ...
                                <div class="col-sm-6 col-lg-3">
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            <img alt="demo-img" class="img-fluid b-r-8"
                                                 src="../assets/images/landing/floating-lable.jpg">
                                            <div class="demo-box">
                                                <h6 class="m-0 f-w-500 f-s-18">Floating Labels</h6>
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="floating_labels.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="select.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="range_slider.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="clipboard.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="file_upload.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="dual_listboxes.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="default_forms.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-secondary icon-btn b-r-22" href="form_wizards.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="form_wizard_1.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="form_wizard_2.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="ready_to_use_form.php" role="button"
                                                   target="_blank">
                                                    <i
                                                        class="ti ti-chevrons-right"></i>
                                                </a>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="ready_to_use_table.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="sign_in.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="sign_in_1.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="sign_up.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="sign_up_1.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="pwd_create.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="pwd_reset.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="lock_screen.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="two_step_verification.php" role="button"
                                                   target="_blank">
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-danger icon-btn b-r-22" href="error_400.php" role="button"
                                                   target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-success icon-btn b-r-22" href="error_403.php" role="button"
                                                   target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-primary icon-btn b-r-22" href="error_404.php" role="button"
                                                   target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-warning icon-btn b-r-22" href="error_500.php" role="button"
                                                   target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                                    ...
                                    <div class="card demo-card">
                                        <div class="card-body">
                                            ...
                                            <div class="demo-box">
                                                ...
                                                <a class="btn btn-light-info icon-btn b-r-22" href="error_503.php" role="button"
                                                   target="_blank">
                                                    <i class="ti ti-chevrons-right"></i>
                                                </a>
                                            </div>
                        ...
                        <div class="col-lg-12 col-sm-6 mb-3">
                            <div class="card-boxs">
                                ...
                                <div class="box-content">
                                    ...
                                    <a class="btn btn-primary" href="https://phpstack-1384472-5121645.cloudwaysapps.com/document/php/axelit/index.html" role="button" target="_blank">Check
                                        Document</a>
                                </div>
                        ...
                        <div class="slider-container">
                            <div class="slider-container-box">
                                <div class="slider-slideUp">
                                    <img alt="card-img" class="img-fluid" src="../assets/images/landing/landing-bg.png">
                                </div>
                                <div class="slider-slideUp">
                                    <img alt="card-img" class="img-fluid" src="../assets/images/landing/landing-bg.png">
                                </div>
                            ...
                            <div class="slider-container-box slider-left">
                                <div class="slider-slideDown">
                                    <img alt="card-img" class="img-fluid"
                                         src="../assets/images/landing/landing-bg-1.png">
                                </div>
                                <div class="slider-slideDown">
                                    <img alt="card-img" class="img-fluid"
                                         src="../assets/images/landing/landing-bg-1.png">
                        ...
                        <div>
                            ...
                            <div class="element-content">
                                ...
                                <p>Apply Custom button styles to forms, dialogs, and various elements, featuring support
                                    for multiple
                                    sizes and states.</p>
                                <a class="link-btn link-primary mt-3 " href="./buttons.php" role="button">View Buttons
                                    <i
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create stylish cards with Admin Element for organized content presentation and a
                                    sleek user
                                    interface.</p>
                                <a class="link-btn link-primary mt-3" href="./cards.php" role="button">View Cards <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="element-content">
                                ...
                                <p>Easily design lists with Admin Element intuitive elements for structured content
                                    display, enhancing
                                    user experience.</p>
                                <a class="link-btn link-primary mt-3" href="./list.php" role="button">View List <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create alerts using Admin Elements intuitive elements to effectively communicate
                                    messages.</p>
                                <a class="link-btn link-primary mt-3" href="./alert.php" role="button">View Alerts <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create collapsible accordion in Admin for organized content presentation, optimizing
                                    user
                                    interaction.</p>
                                <a class="link-btn link-primary mt-3" href="./accordions.php" role="button">View
                                    Accordions <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create dropdown using Admin Elements for enhanced user interaction and intuitive
                                    navigation.</p>
                                <a class="link-btn link-primary mt-3" href="./dropdown.php" role="button">View Dropdown
                                    <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Create dividers effortlessly with Admin Elements utilities, enhancing content
                                    organization. </p>
                                <a class="link-btn link-primary mt-3" href="./divider.php" role="button">View Dividers
                                    <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Utilize Progress components for visually appealing representation of task completion
                                    and data
                                    loading. </p>
                                <a class="link-btn link-primary mt-3" href="./progress.php" role="button">View Progress
                                    <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="element-content">
                                ...
                                <p>Employ Admin notification Elements for streamlined user alerts, enhancing
                                    ...
                                    experience. </p>
                                <a class="link-btn link-primary mt-3" href="./notifications.php" role="button">View
                                    Notifications <i
                                        class="ti ti-chevrons-right mt-2"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="slider-container">
                        <div class="slider-container-box">
                            <div class="slider-slideLeft">
                                <img alt="" class="img-fluid" src="../assets/images/landing/dark-layout.png">
                            </div>
                        </div>
                        <div class="slider-container-box slider-left">
                            <div class="slider-slideRight">
                                <img alt="" class="img-fluid" src="../assets/images/landing/dark-layout-1.png">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card equal-card color-hint-card">
                        <div class="card-body">
                            ...
                            <div>
                                <img alt="" class="img-fluid" src="../assets/images/landing/color-hint.gif">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card speed-performance-card">
                        <div class="card-body text-center">
                            ...
                            <div class="mt-5">
                                <img alt="" class="img-fluid" src="../assets/images/landing/speed-performance.png">
                            </div>

                            <div class="performance-content ">
                                <div class="text-end">
                                    <img alt="img" class="arrow-shape" src="../assets/images/landing/arrow-shape.png">
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-content text-center">
                        <img alt="logo" src="../assets/images/logo/4.png">
