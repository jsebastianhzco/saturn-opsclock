                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-newspaper f-s-16"></i> Other Pages
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Sitemap</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="vertical-sitemap">
                                        <ul class="list-unstyled mb-0">
                                            <li class="p-0 parent-title"><a
                                                        class="fw-medium fs-14 text-primary-dark f-w-600"
                                                        href="">axelit</a>
                                            </li>
                                            <li>
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600" href="">Dashboards</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-server f-s-18 me-1"></i>Apps</a>
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                                    <a href=""> calender </a>
                                                                </li>
                                                        ...
                                                        <li>
                                                            <a class="" href=""><i
                                                                        class="ti ti-chart-treemap f-s-18 me-1 "></i>
                                                                Widgets
                                                            </a>
                                                        </li>
                                                ...
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600" href="">
                                                            COMPONENT</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-first-aid-kit f-s-18 me-1 "></i>Ui
                                                                Kit</a>
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                                    <a href=""> cheatsheet</a>
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-briefcase f-s-18 me-1  "></i>Advance
                                                                UI</a>
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                                    <a href=""> Modals</a>
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-icons f-s-18 me-1 "></i>Icons</a>
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-album f-s-18 me-1 "></i>Misc</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600" href=""> MAP
                                                            & CHARTS</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""> <i
                                                                        class="ti ti-map f-s-18 me-1 "></i>Map</a>
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-chart-pie f-s-18 me-1 "></i>Chart</a>
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                                    <a href=""> Chart js</a>
                                                                </li>
                                                ...
                                                <div class="first-part">
                                                    ...
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-table f-s-18 me-1 "></i>Table </a>
                                                            <ul class="third-part list-unstyled">
                                                                <li><a href="">BasicTable</a></li>
                                                                <li><a href="">Data Table</a></li>
                                                                <li><a href="">List Js</a></li>
                                                                <li><a href="">Advanvce Table</a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-forms f-s-18 me-1 "></i> Forms
                                                                elements</a>
                                                            <ul class="third-part list-unstyled">
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""> <i
                                                                        class="ti ti-table-import f-s-18 me-1 "></i>
                                                                Ready to use </a>
                                                            <ul class="third-part list-unstyled">
                                                ...
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600"
                                                           href="">PAGES</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-news f-s-18 me-1 "></i>Auth Pages
                                                            </a>
                                                            <ul class="third-part list-unstyled">
                                                                ...
                                                                <li><a href="">Two-Step Verification with
                                                                        Bgimage</a></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-article-off f-s-18 me-1 "></i>Error
                                                                Pages </a>
                                                            <ul class="third-part list-unstyled">
                                                        ...
                                                        <li>
                                                            <a class="text-primary-dark f-w-600" href=""><i
                                                                        class="ti ti-box-multiple f-s-18 me-1 "></i>Other
                                                                Pages </a>
                                                            <ul class="third-part list-unstyled">
                                                ...
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600" href="">OTHERS</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            <a class="" href=""><i
                                                                        class="ti ti-box-multiple-2 f-s-18 me-1 "></i>2
                                                                level</a>
                                                            <ul class="third-part list-unstyled">
                                                                <li><a href="">Blank</a></li>
                                                        ...
                                                        <li>
                                                            <a class="" href=""><i
                                                                        class="ti ti-file-text f-s-18 me-1 "></i>Document</a>
                                                        </li>
                                                        <li>
                                                            <a class="" href=""><i
                                                                        class="ti ti-headset f-s-18 me-1 "></i>Support</a>
                                                        </li>
                                    ...
                                    <div class="vertical-sitemap">
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600 " href=""><i
                                                                    class="ti ti-home f-s-18 me-1"></i>Dashboards</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
                                                            ...
                                                            <div class="content-box">
                                                                <p>E-commerce dashboard involves presenting key
                                                                    metrics and insights that help
                                                                    businesses make informed decisions. Here are
                                                                    some essential components and ideas
                                                        ...
                                                        <li>
                                                            ...
                                                            <ul class="second-part list-unstyled">
                                                                <li>
                                                                    <a href="">Email</a>
                                                                    <div class="content-box">
                                                                        <p>Creating effective content for an
                                                                            e-commerce email page involves
                                                                            presenting
                                                ...
                                                <div class="first-part">
                                                    <div class="list-wrap">
                                                        <a class="fw-medium text-primary-dark f-w-600" href=""><i
                                                                    class="ti ti-briefcase me-1"></i>Other
                                                            Pages</a>
                                                    </div>
                                                    <ul class="second-part list-unstyled">
                                                        <li>
