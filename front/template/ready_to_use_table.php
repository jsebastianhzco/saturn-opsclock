                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        ...
                                                        <img src="../assets/images/avtar/8.png" alt=""
                                                             class="img-fluid">
                                                    </div>
                                    ...
                                    <table id="exampledatatable3" class="w-100 display job-resumes-table">
                                        ...
                                        <tr>
                                            <td>
                                                <div
                                                        class="h-30 w-30 d-flex-center b-r-50 overflow-hidden text-bg-success">
                                                    <img src="../assets/images/avtar/9.png" alt=""
                                                         class="img-fluid">
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div
                                                        class="h-30 w-30 d-flex-center b-r-50 overflow-hidden text-bg-dark">
                                                    <img src="../assets/images/avtar/7.png" alt=""
                                                         class="img-fluid">
                                                </div>
                                            </td>
                                            <td>
...
<!-- js-->
<script src="../assets/js/ready_to_use_table.js"></script>
</html>
