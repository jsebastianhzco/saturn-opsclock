                            ...
                            <div class="card-body">
                                ...
                                <div class="profile-top-content">
                                    ...
                                    <div>
                                        ...
                                        <a href="./profile.php" target="_blank" role="button" class="btn btn-light-secondary">View Profile</a>
                                    </div>
                                ...
                                <div class="card draggable-card">
                                    <div class="card-body">
                                        ...
                                        <div class="draggable-card-img">
                                            <a href="../assets/images/dashboard/education/video.mp4" class="glightbox">
                                                <img src="../assets/images/dashboard/education/02.png" class="img-fluid h-225 m-auto" alt="image">
                            ...
                            <div class="col-6">
                                <div class="card draggable-card">
                                    <div class="card-body">
                                        <div class="draggable-card-img">
                                            <a href="../assets/images/dashboard/education/video.mp4" class="glightbox">
                                                <img src="../assets/images/dashboard/education/03.png" class="img-fluid h-225 m-auto" alt="image">
                                                <div class="video-transparent-box">
                              <span class="bg-dark-800 h-35 w-35 d-flex-center b-r-50">
                                <i class="ph ph-play-circle f-s-18"></i>
                              </span>
                            ...
                            <div class="col-6">
                                <div class="card draggable-card">
                                    <div class="card-body">
                                        <div class="draggable-card-img">
                                            <a href="../assets/images/dashboard/education/video.mp4" class="glightbox">
                                                <img src="../assets/images/dashboard/education/04.png" class="img-fluid h-225 m-auto" alt="image">
                                                <div class="video-transparent-box">
                              <span class="bg-dark-800 h-35 w-35 d-flex-center b-r-50">
                                <i class="ph ph-play-circle f-s-18"></i>
                              </span>
                                        ...
                                        <div class="draggable-card-content pt-3">
                                            ...
                                            <p class="text-secondary f-s-13  mb-0 mt-2">- By <span class="text-dark text-d-underline">  Marques Hilll</span> </p>
                            ...
                            <div class="col-6">
                                <div class="card draggable-card">
                                    <div class="card-body">
                                        <div class="draggable-card-img">
                                            <a href="../assets/images/dashboard/education/video.mp4" class="glightbox">
                                                <img src="../assets/images/dashboard/education/06.png" class="img-fluid h-225 m-auto" alt="image">
                                                <div class="video-transparent-box">
                              <span class="bg-dark-800 h-35 w-35 d-flex-center b-r-50">
                                <i class="ph ph-play-circle f-s-18"></i>
                              </span>
...
<!-- pignose-Calendar js  -->
<script src="../assets/vendor/pignose-Calendar/pignose.calendar.full.min.js"></script>
