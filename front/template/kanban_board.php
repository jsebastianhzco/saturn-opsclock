                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-stack f-s-16"></i> Apps
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Kanban Board</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                                ...
                                                <div class="board-item">
                                                    <div class="board-item-content p-0">
                                                        <div class="board-images">
                                                            <img alt=""
                                                                 class="img-fluid"
                                                                 src="../assets/images/profile-app/07.jpg">
                                                        </div>
                                                        <div class="p-3">
                                                ...
                                                <div class="board-item">
                                                    <div class="board-item-content p-0">
                                                        <div class="board-images">
                                                            <img alt=""
                                                                 class="img-fluid"
                                                                 src="../assets/images/profile-app/10.jpg">
                                                        </div>
                                                        <div class="p-3">
                                                ...
                                                <div class="board-item">
                                                    <div class="board-item-content p-0">
                                                        <div class="board-images">
                                                            <img alt=""
                                                                 class="img-fluid"
                                                                 src="../assets/images/profile-app/05.jpg">
                                                        </div>
                                                        <div class="p-3">
                                                ...
                                                <div class="board-item">
                                                    <div class="board-item-content p-0">
                                                        <div class="board-images">
                                                            <img alt=""
                                                                 class="img-fluid"
                                                                 src="../assets/images/profile-app/09.jpg">
                                                        </div>
                                                        <div class="p-3">
...
<!-- kanban_board js-->
<script src="../assets/js/kanban_board.js"></script>
