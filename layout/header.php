                                    ...
                                    <ul class="search-list">
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="api.php" target="_blank"><h6
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="privacy_policy.php" target="_blank"><h6
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="terms_condition.php" target="_blank"><h6
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="sign_in.php" target="_blank"><h6
                                        ...
                                        <li class="search-list-item">
                                            ...
                                            <div class="search-list-content">
                                                <a href="data_table.php" target="_blank"><h6
                                    ...
                                    <div class="head-box">
                                        ...
                                        <div class="flex-grow-1">
                                            <a class="text-primary-dark mb-0 f-w-600 f-s-16"
                                               href="product_details.php" target="_blank">
                                    ...
                                    <div class="head-box">
                                        ...
                                        <div class="flex-grow-1">
                                            <a class="text-danger-dark mb-0 f-w-600 f-s-16"
                                               href="product_details.php" target="_blank">Sandals<span
                            ...
                            <div class="offcanvas-footer">
                                <div class="head-box-footer p-3">
                                    ...
                                    <div class="header-cart-btn">
                                        <a class="btn btn-light-primary" href="./cart.php" role="button"
                                           target="_blank">
                                            <i class="ti ti-eye"></i> View Cart</a>
                                        <a class="btn btn-light-success" href="./checkout.php"
                            ...
                            <div class="offcanvas-body notification-offcanvas-body app-scroll p-0">
                                <div class="head-container notification-head-container">
                                    <div class="notification-message head-box">
                                        ...
                                        <div class="message-content-box flex-grow-1 ps-2">
                                            ...
                                            <a class="f-s-15 text-secondary mb-0"
                                               href="./read_email.php" target="_blank"><span
                                    ...
                                    <div class="notification-message head-box">
                                        ...
                                        <div class="message-content-box flex-grow-1 ps-2">
                                            <a class="f-s-15 text-secondary mb-0" href="./read_email.php"
                                               target="_blank">Hey
                                                <span
