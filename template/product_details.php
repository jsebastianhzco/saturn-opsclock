                                ...
                                <span class="selectitem">
                                  40
                                    ...
                                    <div class="product-details-btn text-end mt-4">
                                        <a class="btn btn-primary rounded" href="cart.php" role="button">Add To
                                            Cart</a>
                                        <a class="btn btn-success rounded" href="checkout.php" role="button">Buy
                                            Now</a>
                                        <a class="btn btn-danger rounded" href="wishlist.php" role="button">Add to
                                            Wishlist</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                EM
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="product-details-table">
                                                    ...
                                                    <td>
                                                        <div class="position-relative">
                                                            <img alt="product-image"
                                                                 ...
                                                                 src="../assets/images/ecommerce/29.png">
                                                            <div class="mg-s-40">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="position-relative">
                                                            <img alt="product-image"
                                                                 class="w-45 h-45 position-absolute"
                                                                 src="../assets/images/ecommerce/33.png">
                                                            <div class="mg-s-40">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="position-relative">
                                                            <img alt="product-image"
                                                                 class="w-45 h-45 position-absolute"
                                                                 src="../assets/images/ecommerce/34.png">
                                                            <div class="mg-s-40">
                                                                <h6 class="text-dark f-w-600 txt-ellipsis-1">
                                                                    T-shirt</h6>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="position-relative">
                                                            <img alt="product-image"
                                                                 class="w-45 h-45 position-absolute"
                                                                 src="../assets/images/ecommerce/30.png">
                                                            <div class="mg-s-40">
                                                                <h6 class="text-dark f-w-600 txt-ellipsis-1">
                                                                    Airpods</h6>
                                            ...
                                            <a class="btn btn-primary w-100 rounded" href="product.php"
