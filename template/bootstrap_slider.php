                                ...
                                <div id="carouselExample" class="carousel slide">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../assets/images/bootstrapslider/01.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/images/bootstrapslider/07.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/images/bootstrapslider/08.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="carouselExampleIndicators" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../assets/images/bootstrapslider/02.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/images/bootstrapslider/07.jpg" class="w-100 d-block"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="carouselExampleCaptions" class="carousel slide">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../assets/images/bootstrapslider/03.jpg" class="w-100 d-block"
                                                 alt="...">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="carouselExampleSlidesOnly" class="carousel slide"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="../assets/images/bootstrapslider/04.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="../assets/images/bootstrapslider/07.jpg" class="w-100 d-block"
                                ...
                                <div id="carouselExampleInterval" class="carousel slide"
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active" data-bs-interval="1000">
                                            <img src="../assets/images/bootstrapslider/05.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                ...
                                <div class="carousel slide" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active" data-bs-interval="10000">
                                            <img src="../assets/images/bootstrapslider/06.jpg" class="w-100 d-block"
                                                 alt="...">
                                        </div>
                                        <div class="carousel-item" data-bs-interval="2000">
                                            <img src="../assets/images/bootstrapslider/07.jpg" class="w-100 d-block"
