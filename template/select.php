                                ...
                                <div class="row app-form">
                                    <div class="col-xl-6">
                                        <div class="select_primary">
                                            ...
                                            <select class="select-basic-multiple-four w-100 select_primary" name="states[]"
                                                    multiple="multiple">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="select_secondary mt-xl-0 mt-4">
                                            ...
                                            <select class="select-basic-multiple-four w-100" name="states[]" multiple="multiple">
                                                <option value="AL" selected>Alabama</option>
                                                <option value="WY" selected>Wyoming</option>
                                                <option value="WY">Coming</option>
                                                <option value="WY">Hanry Die</option>
                                ...
                                <div class="row app-form">
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <div class="mt-4">
                                            ...
                                            <select class=" select-example-rtl w-100" name="states[]" multiple="multiple">
                                                <option value="AL">Alabama</option>
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        ...
                                        <div class="text-end">
                                            <button class="btn btn-primary select-basic-multiple-seven mt-3">Enable</button>
                                            <button class="btn btn-secondary select-basic-multiple-six mt-3">Disable</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row main-select">
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <form class="app-form">
                                            <select class="form-select rounded-pill my-3" aria-label="Default select example">
                                    ...
                                    <div class="col-md-6 col-xl-4">
                                        <form class="app-form">
                                            <select class="form-select my-3" aria-label="Disabled select example" disabled="">
