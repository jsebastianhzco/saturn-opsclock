                            ...
                            <div class="card-body ">
                                <div class="multiple-items app-arrow">
                                    <div class="items"><img alt="image" class="img-fluid rounded"
                                                            src="../assets/images/slick/09.jpg">
                                    </div>
                                    <div class="items"><img alt="image" class="img-fluid rounded"
                                                            src="../assets/images/slick/25.jpg">
                                    </div>
                                    <div class="items"><img alt="image" class="img-fluid rounded"
                                                            src="../assets/images/slick/23.jpg">
                                    </div>
                                    <div class="items"><img alt="image" class="img-fluid rounded"
                                                            src="../assets/images/slick/24.jpg">
                                    </div>
                                    <div class="items"><img alt="image" class="img-fluid rounded"
                                                            src="../assets/images/slick/26.jpg">
                                    </div>
                                    <div class="items"><img alt="image" class="img-fluid rounded"
                                                            src="../assets/images/slick/27.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="center-mode app-arrow">
                                    <div class="item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/04.jpg">
                                    </div>
                                    <div class="item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/03.jpg">
                                    </div>
                                    <div class="item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/04.jpg">
                                    ...
                                    <div class="item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/05.jpg">
                                    </div>
                                    <div class="item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/06.jpg">
                                    </div>
                                    <div class="item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/07.jpg">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="responsive app-arrow">
                                    <div class="resopns-item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/10.jpg">
                                    </div>
                                    <div class="resopns-item">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/23.jpg">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="slider add-remove app-arrow">
                                    <div class="p-2">
                                        <img alt="image" class="img-fluid rounded"
                                             src="../assets/images/slick/12.jpg">
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="slider filtering app-arrow">
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/13.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/15.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/14.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/17.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/16.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/18.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/19.jpg">
                                        </div>
                                        <div class="items">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/slick/20.jpg">
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="autoplay-slider app-arrow">
                                            <div class="autoplay-item">
                                                <img alt="image" class="img-fluid rounded"
                                                     src="../assets/images/slick/28.jpg">
                                            </div>
                                            <div class="autoplay-item">
                                                <img alt="image" class="img-fluid rounded"
                                                     src="../assets/images/slick/22.jpg">
                                            </div>
                                            <div class="autoplay-item">
                                                <img alt="image" class="img-fluid rounded"
                                                     src="../assets/images/slick/10.jpg">
                                            ...
                                            <div class="autoplay-item">
                                                <img alt="image" class="img-fluid rounded"
                                                     src="../assets/images/slick/21.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="fade-s app-arrow">
                                            <div class="item">
                                                <img alt="image"
                                                     ...
                                                     src="../assets/images/slick/fade-1.jpg">
                                            </div>
                                            <div class="item">
                                                <img alt="image"
                                                     class="img-fluid rounded"
                                                     src="../assets/images/slick/fade-2.jpg">
                                            </div>
                                            <div class="item">
                                                <img alt="image"
                                                     class="img-fluid rounded"
                                                     src="../assets/images/slick/fade-3.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="">
                                    <div class="slider slider-for mb-3">
                                        ...
                                        <div class="slider-4">
                                            <img alt="image" class="img-fluid rounded"
                                                 src="../assets/images/ecommerce/07.jpg">
                                        </div>
                                        <div class="slider-5">
                                            <img alt="image" class="img-fluid rounded"
