                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-9">
                                            <div class="tab-content" id="BasicContent">
                                                <div class="tab-pane fade show active" id="v-features-tab-pane" role="tabpanel"
                                                    ...
                                                    <form class="app-form">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="mb-3">
                                                                    <label class="form-label f-w-500">Usename</label>
                                                                        ...
                                                                        <div>
                                                                            <form class="app-form">
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <div class="mb-3">
                                                                                            <label class="form-label f-w-500">Cradholder Name</label>
                                                                                            <input type="text" class="form-control" placeholder="Olaf">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-6">
                                                                                        <div class="mb-3">
                                                                                            <label class="form-label f-w-500">Crad Number</label>
                                              ...
                                              <img src="../assets/images/checkbox-radio/logo1.png" class="w-30 h-30"
                                                   alt="">
                                              <span class="ms-2">
                                                <span class="fs-6 f-w-500">Visa Card</span>
                                                <span class="d-block text-secondary">Select Visa card paymaent
                                                  method</span>
                                              </span>
                                            </span>
                                                                            </label>
                                                                    ...
                                                                    <div class="card-body select-content ">
                                                                        <div class="position-relative">
                                                                            <label class="check-box">
                                                                                ...
                                                                                <span class="radiomark outline-secondary position-absolute"></span>
                                                                                <span class="d-flex align-items-center mg-s-25">
                                              <img src="../assets/images/checkbox-radio/logo3.png" class="w-30 h-30"
                                                   alt="">
                                              <span class="ms-2">
                                                <span class="fs-6 f-w-500">Paypal</span>
                                                <span class="d-block text-secondary">Select Paypal paymaent
                                                  method</span>
                                              </span>
                                            </span>
                                                                            </label>
                    ...
                    <div class="col-12">
                        ...
                        <span class="d-flex align-items-center">
                          ...
                          <span class="text-start ms-3 custome-title d-flex flex-column">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Bussiness Account Wizards</h5>
                            </div>
                            <div class="card-body">
