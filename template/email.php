                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-stack f-s-16"></i> Apps
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Email</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="col-lg-3">
                        <div class="mailbox">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <button class="btn btn-primary w-100 rounded" data-bs-target="#emailBox"
                                    ...
                                    <div class="horizontal-tab-wrapper">
                                        <ul class="email-list mt-3 tabs">
                                            <li class="tab-link active" data-tab="1">
                                                <i class="ti ti-mail fs-5 pe-2"></i> <span
                                                        class="flex-grow-1">Inbox</span> 10+
                                            </li>
                                            <li class="tab-link" data-tab="2"><i
                                                        class="ti ti-send fs-5 pe-2"></i><span
                                                        class="flex-grow-1">Sent</span></li>
                                            <li class="tab-link" data-tab="3"><i
                                                        class="ti ti-file fs-5 pe-2"></i><span
                                                        class="flex-grow-1">Draft</span></li>
                                            <li class="tab-link" data-tab="4"><i
                                                        class="ti ti-star fs-5 pe-2"></i><span
                                                        class="flex-grow-1">
                              Starred </span>
                                                2+
                                            </li>
                                            <li class="tab-link" data-tab="5"><i
                                                        class="ti ti-alert-octagon fs-5 pe-2"></i><span
                                    ...
                                    <div>
                                        <div class="btn-group dropdown-icon-none">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#"><i class="ti ti-album"></i>
                                                        Primary </a></li>
                                                <li><a class="dropdown-item" href="#"><i class="ti ti-tag"></i>
                                                        Promotions </a></li>
                                                <li><a class="dropdown-item" href="#"><i class="ti ti-users"></i>
                                                        Social </a></li>
                                            </ul>
                                        </div>
                                    </div>
                              ...
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                                                ...
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">This is the content of
                                    the email. It may contain anything the user....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox21"
                             ...
                             <i class="ti text-warning star-icon fs-5 ti-star-filled"></i>
                                                ...
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">It enables users to
                                    easily send and receive documents, images, links and ....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox22"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">Companies can use email
                                    to convey information to a large number of ....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox23"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti text-warning star-icon fs-5 ti-star-filled"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">The domain of Gmail is
                                    xyz@gmail.com where ....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox24"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">System Software is
                                    closer to the computer system.....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox25"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">An important feature of
                                    application software is it performs more....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox26"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        ...
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">The application software
                               ...
                               <i class="ti ti-star text-warning star-icon fs-5"></i>
                                                ...
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Neil Fisher</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">Whether you're preparing
                              ...
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                                                ...
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">James Lewis</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">A message or messages
                              ...
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                                                ...
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Neil Fisher</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">E-mail has become one of
                                    ...
                                    <div class="tabs-content" id="tab-3">
                                        <div class="mail-table">
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox5" type="checkbox"
                                                       value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Kylie Wright</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">One of the great things
                                    about it is that it’s fast, cost-effective, and convenient....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox6" type="checkbox"
                                                       value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Diana White</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">Email messages are sent
                                    from software programs and web browsers, collectively as email....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox7" type="checkbox"
                                                       value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star-filled text-warning star-icon fs-5"></i>
                                                ...
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Gene Raynor</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">The sender’s mail
                                    server, also called a Agent (MTA), initiates a Simple....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox8" type="checkbox"
                                                       value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Gene Hart</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">The SMTP “envelope” is
                                    ...
                                    <div class="tabs-content" id="tab-4">
                                        <div class="mail-table">
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox9" type="checkbox"
                                                       value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star-filled text-warning star-icon fs-5"></i>
                            </span>
                                    ...
                                    xyz@gmail.com where ....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox10"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star-filled text-warning star-icon fs-5"></i>
                            </span>
                                    ...
                                    easily send and receive documents, images, links and ....</span></a>
                                            ...
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox11"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                              <i class="ti ti-star-filled text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Gene Raynor</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">Computer-based messaging
                                    ...
                                    <div class="tabs-content" id="tab-5">
                                        <div class="mail-table d-flex align-items-center justify-content-center">
                                            <div class="spam-box text-center">
                                                <img alt="" src="../assets/images/icons/spam..png">
                                                <h5>No spam here</h5>
                                                <p>The MUA formats the message in email format and uses the
                                                    submission a profile of the
                                    ...
                                    <div class="tabs-content" id="tab-6">
                                        <div class="mail-table">
                                            <div class="mail-box">
                                                <input class="form-check-input" id="inlineCheckbox12"
                                                       type="checkbox" value="option1">
                                                <span class="ms-2 me-2">
                               <i class="ti ti-star text-warning star-icon fs-5"></i>
                            </span>
                                                <div class="flex-grow-1 position-relative">
                                                    ...
                                                    <div class="mg-s-45">
                                                        <h6 class="mb-0 f-w-600">Simon Young</h6>
                                                        <a href="./read_email.php"><span
                                                                    class="f-s-13 text-secondary">Internet email messages
