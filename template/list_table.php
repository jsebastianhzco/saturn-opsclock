                                ...
                                <div id="myTable">
                                    ...
                                    <div class="overflow-auto app-scroll">
                                        <table class="table table-bottom-border  list-table-data align-middle mb-0">
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0" type="checkbox" class="ms-2" name="item"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0 " type="checkbox" name="item" value="2"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0 " type="checkbox" name="item" value="3"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0 " type="checkbox" name="item" value="4"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0 " type="checkbox" name="item" value="5"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0 " type="checkbox" name="item" value="6"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0" type="checkbox" name="item" value="7"></th>
                                            ...
                                            <tr>
                                                <th scope="row"><input class="form-check-input mt-0 " type="checkbox" name="item" value="8"></th>
...
<!-- list table js -->
<script src="../assets/js/list_js.js"></script>
