                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control b-r-right"
                                                           placeholder="Enter Your Contect" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xl-8 floating-select">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select">
                                                    ...
                                                    <option value="2">Docter Check</option>
                                        ...
                                        <div class="col-md-4 floating-select">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select">
                                                    <option selected="">select Your Docter</option>
                                    ...
                                    <ul class="nav step-status " id="justify-about-tab" role="tablist">
                                        <li>
                                            <button class="btn nav-link flex-grow-1 text-start active" id="carditcard-tab"
                                                ...
                                                <img src="../assets/images/checkbox-radio/logo1.png" class="w-35 h-35"
                                                     alt="">
                                        ...
                                        <li>
                                            <button class="btn nav-link text-start flex-grow-1" id="visacard-tab"
                                                    ...
                                                    tabindex="-1">
                                                <img src="../assets/images/checkbox-radio/logo2.png" class="w-35 h-35"
                                                     alt="">
                                                <span>Visa Card</span>
                                            </button>
                                        </li>
                                        <li>
                                            <button class="btn nav-link text-start flex-grow-1" id="paypal-tab"
                                                    ...
                                                    tabindex="-1">
                                                <img src="../assets/images/checkbox-radio/logo3.png" class="w-35 h-35"
                                                     alt="">
                                                <span>Paypal</span>
                                            </button>
                                        </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                       placeholder="Enter Parentname" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Father Contect</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Mother Contect</label>
                                                <input type="text" class="form-control" placeholder="xxx-xxxx-xxx"
                                                       required>
                                            </div>
                                        </div>
...
<!-- js -->
<script src="../assets/js/ready_to_use_form.js"></script>
