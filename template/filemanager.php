                ...
                <div class="row m-1">
                    <div class="col-12 ">
                        ...
                        <ul class="app-line-breadcrumbs mb-3">
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Filemanager</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <span class="d-block text-center mb-3">
                                                                      <img alt="" class="img-fluid"
                                                                           src="../assets/images/icons/zip.png">
                                                            </span>
                                            ...
                                            <div class="col-sm-6 col-xl-4 col-xxl-3">
                                                <div class="card quick-access border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="d-block text-center mb-3">
                                  <img alt="" class="img-fluid" src="../assets/images/icons/pdf.png">
                                </span>
                                            ...
                                            <div class="col-sm-6 col-xl-4 col-xxl-3">
                                                <div class="card  quick-access border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="d-block text-center mb-3">
                                  <img alt="" class="img-fluid" src="../assets/images/icons/file.png">
                                </span>
                                            ...
                                            <div class="col-sm-6 col-xl-4 col-xxl-3">
                                                <div class="card  quick-access border-0">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="d-block text-center mb-3">
                                  <img alt="" class="img-fluid" src="../assets/images/icons/gallary.png">
                                </span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div>
                                                            <img alt=""
                                                                 class="w-20 h-20"
                                                                 src="../assets/images/icons/gallary.png">
