                        ...
                        <div class="content-wrapper mt-3">
                            <div id="tab-1" class="tabs-content active">
                                <div class="card">
                                        ...
                                        <div class="row">
                                            <div class=" col-md-6 col-xl-4 ">
                                                <div class="card team-box-card hover-effect overflow-hidden">
                                                    <div class="team-box">
                                                        <img src="../assets/images/team/6.jpg" class="card-img-top" alt="...">
                                                    </div>
                                  ...
                                  <span
                                    ...
                                    <img src="../assets/images/avtar/4.png" alt="" class="img-fluid b-r-50 ">
                                                    ...
                                                    <div class="taem-content">
                                                        ...
                                                        <div class="team-details">
                                                            <div class="taem-contentbox">
                                                                <p class="f-w-500"><a href="./project.php">Projects</a></p>
                                                                <p class="text-center">20</p>
                                                            </div>
                                                            <div class="taem-contentbox">
                                                                <p class="f-w-500"><a href="./to_do.php">Tasks</a></p>
                                            ...
                                            <div class=" col-md-6 col-xl-4 ">
                                                <div class="card team-box-card hover-effect overflow-hidden">
                                                    <div class="team-box">
                                                        <img src="../assets/images/team/5.jpg" class="card-img-top" alt="...">
                                                    </div>
                                                    <div class="team-container">
                                                        <div class="team-pic">
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="../assets/images/avtar/2.png" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="../assets/images/avtar/9.png" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="../assets/images/avtar/15.png" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                            ...
                            <div id="tab-2" class="tabs-content">
                                <div class="card">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="../assets/images/avtar/5.png" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                  <img src="../assets/images/avtar/7.png" alt="" class="img-fluid b-r-50 ">
                                </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                  <img src="../assets/images/avtar/8.png" alt="" class="img-fluid b-r-50 ">
                                </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                            ...
                            <div id="tab-3" class="tabs-content">
                                <div class="card">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                    <img src="../assets/images/avtar/10.png" alt="" class="img-fluid b-r-50 ">
                                  </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
                                  ...
                                  <span
                                          class="bg-secondary h-80 w-80 d-flex-center b-r-50 position-relative overflow-hidden">
                                  <img src="../assets/images/avtar/12.png" alt="" class="img-fluid b-r-50 ">
                                </span>
                                                        </div>
                                                    </div>
                                                    <div class="taem-content">
