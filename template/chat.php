                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-stack f-s-16"></i> Apps
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Chat</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row position-relative chat-container-box">
                    <div class="col-lg-4 col-xxl-3  box-col-5">
                        ...
                        <span class="chatdp h-45 w-45 d-flex-center b-r-50 position-relative bg-danger">
                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/9.png">
                          <span
                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                        ...
                                        <div>
                                            <div class="btn-group dropdown-icon-none">
                                                <a aria-expanded="false" data-bs-auto-close="true"
                                ...
                                <div class="card-body">
                                    <div class="chat-tab-wrapper">
                                        <ul class="tabs chat-tabs">
                                            <li class="tab-link active" data-tab="1"><i
                                                        class="ph-fill  ph-chat-circle-text f-s-18 me-2"></i>Chat
                                            </li>
                                            <li class="tab-link" data-tab="2"><i
                                                        class="ph-fill  ph-wechat-logo f-s-18 me-2"></i>Updates
                                            </li>
                                            <li class="tab-link" data-tab="3"><i
                                                        class="ph-fill  ph-phone-call f-s-18 me-2"></i>Contact
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="content-wrapper">
                                                ...
                                                <div class="mt-3">
                                                    <ul class="nav nav-tabs app-tabs-primary tab-light-primary chat-status-tab border-0 justify-content-between mb-0 pb-0"
                                                        ...
                                                        <li class="nav-item" role="presentation">
                                                            <button aria-controls="private-tab-pane"
                                                                    aria-selected="false"
                                                                    ...
                                                                    tabindex="-1"
                                                                    type="button"><i
                                                                        class="ph-fill  ph-lock-key-open me-2"></i>Private
                                                            </button>
                                                        </li>
                                                        <li class="nav-item" role="presentation">
                                                            <button aria-controls="groups-tab-pane"
                                                                    aria-selected="false"
                                                                    class="nav-link"
                                                    ...
                                                    <div class="tab-content" id="BasicContent">
                                                        <!-- Private Chat -->
                                                        <div aria-labelledby="private-tab"
                                                  ...
                                                  class="position-absolute top-0 end-0 p-1 bg-secondary border border-light rounded-circle"></span>
                                                                    ...
                                                                    <div class="flex-grow-1 text-start mg-s-50">
                                                                        <p class="mb-0 f-w-500 text-dark txt-ellipsis-1">
                                                                            Mark Walsh</p>
                                                                        <p class="text-secondary mb-0 f-s-12 mb-0 chat-message">
                                                                            <i class="ti ti-checks"></i> Hi! Work is
                                                                            done
                                                                        </p>
                                                                    </div>
                                                                    <div>
                                                  ...
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                                                    ...
                                                                    <div class="flex-grow-1 text-start mg-s-50">
                                                                        <p class="mb-0 f-w-500 text-dark txt-ellipsis-1">
                                                                            Jerry Ladies</p>
                                                                        <p class="text-secondary mb-0 f-s-12 mb-0 chat-message">
                                                                            <i class="ti ti-checks"></i> I'm waiting
                                                                        </p>
                                                                    </div>
                                                                    <div>
                                                                        <p class="f-s-12 chat-time">2:30AM</p>
                                        ...
                                        <span class="h-45 w-45 d-flex-center b-r-50 position-relative bg-warning">
                                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/5.png">
                                          <span
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                        </span>
                                                                    </div>
                                        ...
                                        <span class="h-45 w-45 d-flex-center b-r-50 position-relative bg-secondary">
                                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/7.png">
                                          <span
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                        </span>
                                                                    </div>
                                                                ...
                                                                <div class="chat-contactbox">
                                                                    <div class="position-absolute">
                                        <span class="h-45 w-45 d-flex-center b-r-50 position-relative bg-primary">
                                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/8.png">
                                          <span
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                        </span>
                                                                    </div>
                                          ...
                                          <span
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                                                ...
                                                                <div class="chat-contactbox">
                                                                    <div class="position-absolute">
                                        <span class="h-45 w-45 d-flex-center b-r-50 position-relative bg-success">
                                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/10.png">
                                          <span
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                        </span>
                                                                    </div>
                                                                ...
                                                                <div class="chat-contactbox">
                                                                    <div class="position-absolute">
                                        <span class="h-45 w-45 d-flex-center b-r-50 position-relative bg-danger">
                                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/11.png">
                                          <span
                                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                        </span>
                                                                    </div>
                                                                    <div class="flex-grow-1 text-start mg-s-50">
                                                                        <p class="mb-0 f-w-500 text-dark txt-ellipsis-1">
                                                                            Fleta Walsh</p>
                                                                        <p class="text-muted mb-0 text-success f-s-12 chat-message">
                                                                            Typing....</p>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <!-- Group Chat -->
                                                        <div aria-labelledby="groups-tab" class="tab-pane fade"
                                                             id="groups-tab-pane"
                                                             role="tabpanel" tabindex="0">
                                                            <div class="chat-contact chat-group-list">
                                                                ...
                                                                <div class="chat-contactbox">
                                                                    ...
                                                                    <div class="flex-grow-1 text-start mg-s-75">
                                                                        <p class="mb-0 f-w-500 text-dark txt-ellipsis-1">
                                                                            client Group</p>
                                                                        <p class="text-muted text-success f-s-12 chat-message">
                                                                            Typing...</p>
                                                                    </div>
                                                                    <div>
                                                                        <p class="f-s-12 chat-time">Now</p>
                                        ...
                                        <div class="tabs-content" id="tab-3">
                                            <div class="chat-contact tabcontent chat-contact-list">
                                                <div class=" d-flex align-items-center py-3">
                                                    <div>
                                <span class="h-40 w-40 d-flex-center b-r-50 position-relative bg-info">
                                  <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/13.png">
                                  <span
                                          class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                </span>
                                                    </div>
                                ...
                                <span class="h-40 w-40 d-flex-center b-r-50 position-relative bg-danger">
                                  <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/12.png">
                                  <span
                                          class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                </span>
                                                    </div>
                                                    <div class="flex-grow-1 ps-2">
                                                        <p class="contact-name text-dark mb-0 f-w-500">Fleta
                                                            Walsh</p>
                                ...
                                <span class="h-40 w-40 d-flex-center b-r-50 position-relative bg-success">
                                  ...
                                  <span
                                          class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                                                    ...
                                                    <div class="flex-grow-1 ps-2">
                                                        <p class="contact-name text-dark mb-0 f-w-500">Mark
                                                            Walsh</p>
                    ...
                    <div class="col-lg-8 col-xxl-9 box-col-7">
                        ...
                        <span class="profileimg h-45 w-45 d-flex-center b-r-50 position-relative bg-light">
                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/14.png">
                          <span
                                  class="position-absolute top-0 end-0 p-1 bg-success border border-light rounded-circle"></span>
                        </span>
                                    </a>
                                    ...
                                    <button class="btn btn-light-success h-45 w-45 icon-btn b-r-22 me-sm-2"
                                            data-bs-target="#exampleModal"
                                            data-bs-toggle="modal" type="button">
                                        <i class="ti ti-phone-call f-s-20"></i>
                                    </button>
                                    <div aria-hidden="true" class="modal fade" id="exampleModal" tabindex="-1">
                                    ...
                                    <span
                                      ...
                                      <i class="ti ti-phone-call "></i>
                                                                ...
                                                                <span class="bg-danger h-40 w-40 d-flex-center b-r-50 ms-4 call-btn pointer-events-auto"
                                                                      data-bs-dismiss="modal">
                                    ...
                                    <button class="btn btn-light-primary h-45 w-45 icon-btn b-r-22 me-sm-2"
                                            data-bs-target="#exampleModal1"
                                            data-bs-toggle="modal" type="button">
                                        <i class="ti ti-video f-s-20"></i>
                                    </button>
                                    <div aria-hidden="true" class="modal fade" id="exampleModal1" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-body p-0">
                                                <div class="call">
                                    ...
                                    <span class="bg-white h-35 w-35 d-flex-center b-r-50 ms-4">
                                      <i class="ti ti-microphone text-dark"></i>
                                                                ...
                                                                <span class="bg-danger h-45 w-45 d-flex-center b-r-50 ms-4 animate__pulse animate__animated animate__infinite animate__faster call-btn pointer-events-auto"
                                                                      data-bs-dismiss="modal">
                                      <i class="ti ti-phone"></i>
                                    </span>
                                                                <span class="bg-white h-35 w-35 d-flex-center b-r-50 ms-4">
                                    ...
                                    <div>
                                        <button aria-expanded="false"
                                                class="btn btn-light-secondary h-45 w-45 icon-btn b-r-22 me-sm-2"
                                                data-bs-auto-close="true"
                                                data-bs-toggle="dropdown">
                                        ...
                                        <ul class="dropdown-menu" data-popper-placement="bottom-start">
                                            ...
                                            <li><a class="dropdown-item" href="#"><i class="ti ti-phone-call"></i>
                                                    <span
                                                            class="f-s-13">Contact Settings</span></a>
                                            </li>
                                    ...
                                    <div class="position-relative">
                                        <div class="chat-box-right">
                                            <div>
                                                ...
                                                <p class="chat-text">We completed the initial research phase and the
                        ...
                        <span class="chatdp h-45 w-45 position-absolute start-0 b-r-50 bg-light">
                          <img alt="" class="img-fluid b-r-50" src="../assets/images/avtar/14.png">
                                    ...
                                    <div class="position-relative">
                                        <div class="chat-box-right">
                                            <div>
                                                <p class="chat-text">We have it scheduled to start next Monday. That
                        ...
                        <span class="chatdp h-45 w-45 b-r-50 position-absolute start-0 bg-light">
                          ...
                          <span class="input-group-text bg-light-secondary ms-2 me-2 b-r-10 ">
                            <a class="emoji-btn d-flex-center" data-bs-original-title="Emoji" data-bs-placement="top"
                               data-bs-toggle="tooltip" role="button">
                              <i class="ti ti-mood-smile f-s-18"></i>
                            </a>
                          </span>
                                            <input aria-label="Recipient's username" class="form-control b-r-6"
                                                   placeholder="Type a message"
                                                   type="text">
                                            <button class="btn btn-sm btn-light-primary ms-2 me-2 b-r-4"
                                                    type="button"><i
                                                        class="ti ti-send"></i> <span>Send</span></button>
                                        </div>
                                    </div>
                                    <div class="d-none d-sm-block">
                                        <a class="bg-light-secondary h-50 w-50 d-flex-center b-r-10 ms-1"
                                    ...
                                    <div>
                                        <div class="btn-group dropdown-icon-none d-sm-none">
                                            <a aria-expanded="false" class="h-35 w-35 d-flex-center ms-1"
                                               data-bs-auto-close="true"
                                               data-bs-toggle="dropdown" role="button">
