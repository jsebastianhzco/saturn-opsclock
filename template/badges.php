 ...
 <code class="language-html">
        ...
        &nbsp;&lt;div class="d-flex gap-2 flex-wrap"&gt;
         ...
         &lt;/div&gt;
                    ...
                    <!-- Light Badges end -->
                    <!-- Radious option on Badges start -->
                    <div class="col-sm-12 col-xl-6">
                        <div class="card equal-card">
                            <div class="card-header code-header">
                                <h5 class="txt-ellipsis">Radious option on Badges</h5>
  ...
  <code class="language-html">
     ...
     &lt;/div&gt;
                    ...
                    <!-- Radious Badges strat -->
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header code-header" >
                                <h5>Radious Badges</h5>
                                <a  data-bs-toggle="collapse" href="#radiousbadgeexample"
                                    aria-expanded="false" aria-controls="radiousbadgeexample" >
                                    <i class="ti ti-code source" data-source="radiusbadge"></i>
                                </a>
                            ...
                            <pre class="radiusbadge collapse mt-3" id="radiousbadgeexample">
                    <code class="language-html">
