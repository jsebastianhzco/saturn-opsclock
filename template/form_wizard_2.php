                                            ...
                                            <div id="tabs1" class="tab-checkout-content current-checkout-tab">
                                                <div class="cart-box">
                                                    <div class="bg-light-secondary rounded">
                                                        <a href="#"><img src="../assets/images/ecommerce/23.jpg" alt="" class="w-80 "></a>
                                                    </div>
                                                ...
                                                <div class="cart-box">
                                                    <div class="bg-light-secondary rounded">
                                                        <a href="#"><img src="../assets/images/ecommerce/25.jpg" alt=""
                                                ...
                                                <div class="cart-box">
                                                    <div class="bg-light-secondary rounded">
                                                        <a href="#"><img src="../assets/images/ecommerce/13.jpg" alt=""
                                                                         class="w-80 rounded"></a>
                                                    </div>
                                                    <div class="flex-grow-1">
                                                                ...
                                                                <div>
                                                                    <form class="app-form">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label">Cradholder Name</label>
                                                                                    <input type="text" class="form-control" placeholder="Olaf">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <div class="mb-3">
                                                                                    <label class="form-label">Crad Number</label>
                                                            ...
                                                            <div class="card-body select-content ">
                                                                <div class="position-relative">
                                                                    <label class="check-box">
                                                                        ...
                                                                        <span class="radiomark outline-secondary position-absolute"></span>
                                                                        <span class="d-flex align-items-center mg-s-25">
                                          <img src="../assets/images/checkbox-radio/logo1.png" class="w-30 h-30" alt="">
                                          <span class="ms-2">
                                                            ...
                                                            <div class="card-body select-content ">
                                                                <div class="position-relative">
                                                                    <label class="check-box">
                                                                        ...
                                                                        <span class="radiomark outline-secondary position-absolute"></span>
                                                                        <span class="d-flex align-items-center mg-s-25">
                                          <img src="../assets/images/checkbox-radio/logo3.png" class="w-30 h-30" alt="">
                                          <span class="ms-2">
                                          ...
                                          <span class="ms-2">
                                                    ...
                                                    <div class="col-md-6 col-xxl-4">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="mb-3">
                                                                    <h6>Other offers</h6>
                                                                    <p>Buy 2 Bag's save up to 5% to 10% .. </p>
                                                                </div>
                                                                <div class="text-end">
                                                                    <a href="#" class="link-primary text-d-underline">More Offers</a>
                                                                </div>
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        <div class="row">
                                                            <div class="col-6 col-sm-2">
                                                                <img src="../assets/images/ecommerce/23.jpg" alt="product-img" class="img-fluid bg-light-dark b-r-10">
                                                            </div>
                                                            <div class="col-6 col-sm-2">
                                                                <img src="../assets/images/ecommerce/25.jpg" alt="product-img" class="img-fluid bg-light-dark b-r-10">
                                                            </div>
                                                            <div class="col-6 col-sm-2 mt-3 mt-sm-0">
                                                                <img src="../assets/images/ecommerce/13.jpg" alt="product-img" class="img-fluid bg-light-dark b-r-10">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                            ...
                                            <div id="tabs6" class="tab-checkout-content">
                                                <div class="text-center">
                                                    <div class="mb-3">
                                                        <img src="../assets/images/form/done.gif" alt="">
                                                    ...
                                                    <div class="col-md-6 col-xl-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control b-r-right" placeholder="Enter Your Contect" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                            ...
                                                            <div class="card-body select-content ">
                                                                <div class="position-relative">
                                                                    <label class="check-box">
                                                                        ...
                                                                        <span class="d-flex align-items-center mg-s-25">
                                          <span class="ms-2">
                                            <img src="../assets/images/form/15.png" alt="">
                                                            ...
                                                            <div class="card-body select-content ">
                                                                <div class="position-relative">
                                                                    <label class="check-box">
                                                                        ...
                                                                        <span class="d-flex align-items-center mg-s-25">
                                          <span class="ms-2">
                                            <img src="../assets/images/form/13.png" alt="">
                                                            ...
                                                            <div class="card-body select-content ">
                                                                <div class="position-relative">
                                                                    <label class="check-box">
                                                                        ...
                                                                        <span class="d-flex align-items-center mg-s-25">
                                          <span class="ms-2">
                                            <img src="../assets/images/form/14.png" alt="">
                                                    ...
                                                    <div class="col-md-6 col-xl-4">
                                                        <div class="card shadow-none">
                                                            <div class="card-body address-content">
                                                                ...
                                                                <div class="text-center">
                                                                    <img src="../assets/images/form/17.png" alt="">
                                                    ...
                                                    <div class="col-md-6 col-xl-4">
                                                        <div class="card shadow-none">
                                                            <div class="card-body address-content">
                                                                ...
                                                                <div class="text-center">
                                                                    <img src="../assets/images/form/18.png" alt="">
                                                                    ...
                                                                    <div class="col-md-6 col-xl-4">
                                                                        <div class="card shadow-none">
                                                                            <div class="card-body address-content">
                                                                                ...
                                                                                <div class="text-center">
                                                                                    <img src="../assets/images/form/yes.png" alt="">
                                                                                    <p>YES</p>
                                                                    ...
                                                                    <div class="col-md-6 col-xl-4">
                                                                        <div class="card shadow-none">
                                                                            <div class="card-body address-content">
                                                                                ...
                                                                                <div class="text-center">
                                                                                    <img src="../assets/images/form/no.png" alt="">
                                                                                    <p>NO</p>
                                                                                    <p class="text-muted">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-xl-4">
                                                            <div class="card shadow-none">
                                                                <div class="card-body address-content">
                                                                    ...
                                                                    <div class="text-center">
                                                                        <img src="../assets/images/form/19.png" alt="">
                                                                        <h6 class="tab-heading">Locatio 1</h6>
                                                        ...
                                                        <div class="col-md-6 col-xl-4">
                                                            <div class="card shadow-none">
                                                                <div class="card-body address-content">
                                                                    ...
                                                                    <div class="text-center">
                                                                        <img src="../assets/images/form/20.png" alt="">
                                                                        <h6 class="tab-heading">Locatio 2</h6>
