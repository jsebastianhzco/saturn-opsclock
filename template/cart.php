                    ...
                    <div class="col-12 ">
                      ...
                      <span>
                        <i class="ph-duotone  ph-stack f-s-16"></i> Apps
                            ...
                            <li class="active">
                                <a class="f-s-14 f-w-500" href="#">Cart</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <table class="table cart-product-table align-middle" id="example">
                                            ...
                                            <th scope="row">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img alt="" class="w-50 h-50"
                                                         src="../assets/images/ecommerce/32.png">
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center gap-2">
                                                    <img alt="" class="w-50 h-50"
                                                         src="../assets/images/ecommerce/31.png">
                                                    <div class="cart-details">
                                                        <p class="fs-6">
                                                            Backpacks</p>
                            ...
                            <div class="col-md-6 col-xl-12">
                                <div class="card gift-card">
                                    <div class="card-body">
                                        <!-- Gift -->
                                        <div class="d-flex align-items-center gap-2">
                                            <img alt="" class="w-35 h-35" src="../assets/images/ecommerce/01.gif">
